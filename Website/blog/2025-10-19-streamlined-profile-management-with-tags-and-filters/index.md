...
description: "YomiNet 2025.10.18.0 introduces tags and filtering for profiles. Add or remove tags to organize and quickly locate your hosts and networks."
authors: [borntoberoot]
tags: [profile management, tags, new feature]
keywords: [YomiNet, profile management, tags, filters, network profiles, host management]
---

YomiNet 2025.10.18.0 brings a streamlined approach to profile management with the introduction of Tags and Filtering.
...
More information is available in the [official documentation](https://borntoberoot.net/YomiNet/docs/groups-and-profiles).
