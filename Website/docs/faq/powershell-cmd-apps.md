---
description: "Learn how to run command-line applications like WSL, AWS SSM, and K9s within YomiNet using PowerShell profiles and local console settings."
keywords: [YomiNet, PowerShell, command-line apps, WSL, AWS SSM, K9s, CLI applications, local console]
---
