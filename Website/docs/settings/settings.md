---
sidebar_position: 10
description: "Configure where YomiNet stores its settings files. Manage settings file location and portable vs. installed deployment paths."
keywords: [YomiNet, settings location, settings file, configuration storage, settings management]
---
...
| Version        | Path                                              |
| -------------- | ------------------------------------------------- |
| Setup / Archiv | `%UserProfile%\Documents\YomiNet\Settings` |
...
- UNC path (e.g., `\\\\server\\share$\\YomiNet\\Settings`)
...
**Automatic backups**  
YomiNet automatically creates a backup of the settings files before applying any changes. See [Create daily backup](#create-daily-backup) and [Maximum number of backups](#maximum-number-of-backups) for configuration options.
