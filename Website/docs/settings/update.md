---
sidebar_position: 8
description: "Configure automatic update checks in YomiNet. Enable or disable checking for new versions at application startup."
keywords: [YomiNet, update settings, automatic updates, version check, software update]
---
