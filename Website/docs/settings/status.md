---
sidebar_position: 5
description: "Configure the YomiNet status window that appears on network adapter changes and connectivity events."
keywords: [YomiNet, status settings, status window, network change notification, connectivity status]
---
