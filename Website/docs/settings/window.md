---
sidebar_position: 1
description: "Configure YomiNet window behavior including minimize to system tray, close-to-tray, and startup visibility options."
keywords: [YomiNet, window settings, system tray, minimize to tray, close behavior]
---
