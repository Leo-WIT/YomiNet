---
sidebar_position: 4
description: "Configure custom DNS servers used by YomiNet for name resolution across all network tools."
keywords: [YomiNet, network settings, DNS server configuration, custom DNS, name resolution]
---
