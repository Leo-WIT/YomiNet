---
sidebar_position: 2
description: "Customize YomiNet appearance with dark and light themes, accent colors, and custom theme files powered by MahApps.Metro."
keywords: [YomiNet, appearance settings, dark theme, light theme, accent colors, custom theme, MahApps.Metro]
---
...
If enabled, the PowerShell console global profile(s) are modified in the registry under `Computer\HKEY_CURRENT_USER\Console` (`HKCU:\Console`). This adjusts the background of the console and some other settings so that the console window integrates better with the YomiNet application.
