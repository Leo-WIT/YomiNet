---
sidebar_position: 7
description: "Query DNS servers for A, AAAA, CNAME, MX, NS, PTR, and other record types. YomiNet DNS Lookup supports custom and predefined DNS server profiles."
keywords:
  [
    YomiNet,
    DNS lookup,
...
**Type:** `List<YomiNet.Models.Network.DNSServerConnectionInfoProfile>`
