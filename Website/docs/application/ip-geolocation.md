---
sidebar_position: 21
description: "Retrieve geolocation data for public IP addresses and domain names using YomiNet. Shows country, city, ISP, and other network information via ip-api.com."
keywords: [YomiNet, IP geolocation, IP location, GeoIP, IP lookup, IP address location, geolocation tool]
---
