---
sidebar_position: 26
description: "View all active network listeners with IP addresses and ports on your local machine using YomiNet. Identify which processes are listening for connections."
keywords: [YomiNet, listeners, listening ports, open ports, network listeners, port monitoring]
---
