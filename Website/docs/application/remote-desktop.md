---
sidebar_position: 8
description: "Connect to remote computers via RDP with YomiNet Remote Desktop. Features tabbed sessions, profile management, and fullscreen support."
keywords:
  [
    YomiNet,
    remote desktop,
...
**Type:** `YomiNet.Models.RemoteDesktop.GatewayUserSelectedCredsSource`
...
**Type:** `YomiNet.Models.RemoteDesktop.AudioRedirectionMode`
...
**Type:** `YomiNet.Models.RemoteDesktop.AudioCaptureRedirectionMode`
...
**Type:** `YomiNet.Models.RemoteDesktop.KeyboardHookMode`
...
**Type:** `YomiNet.Models.RemoteDesktop.NetworkConnectionType`
