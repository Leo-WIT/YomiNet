...
keywords: [YomiNet, hosts file editor, Windows hosts file, DNS override, hosts file management, edit hosts file]
---
...
The application automatically creates a daily backup of the `hosts` file, retaining up to 5 backups in the same directory (Syntax: `hosts_backup_YomiNet_YYYYMMDD`).
