---
sidebar_position: 4
description: "Scan for open TCP ports on network hosts. YomiNet Port Scanner supports flexible host and port range inputs for comprehensive port scanning."
keywords:
  [
    YomiNet,
    port scanner,
...
**Type:** `List<YomiNet.Models.Network.PortProfileInfo>`
