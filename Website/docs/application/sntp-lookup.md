---
sidebar_position: 15
description: "Query SNTP time servers and compare network time with your local clock. YomiNet SNTP Lookup shows time offsets for accurate synchronization."
keywords: [YomiNet, SNTP lookup, NTP, time server, time synchronization, network time, clock offset]
---
...
**Type:** `List<YomiNet.Models.Network.ServerConnectionInfoProfile>`
