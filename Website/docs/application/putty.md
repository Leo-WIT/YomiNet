---
sidebar_position: 10
description: "Connect via SSH, Telnet, or serial port using the embedded PuTTY client in YomiNet. Supports tabbed sessions and profile-based connections."
keywords:
  [
    YomiNet,
    PuTTY,
...
The integration of PuTTY with YomiNet supports tabs and profiles for hosts. You can establish a connection via a profile (double-click, Enter key or right-click `Connect`) or directly via the [connection](#connect) dialog.
...
**Type:** `YomiNet.Models.PuTTY.ConnectionMode`
...
**Type:** `YomiNet.Models.PuTTY.LogMode`
...
**Default:** `%LocalAppData%\YomiNet\PuTTY_Log`

**Example:** `C:\Users\BornToBeRoot\AppData\Local\YomiNet\PuTTY_Log`
