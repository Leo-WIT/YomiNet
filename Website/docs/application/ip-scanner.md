---
sidebar_position: 3
description: "Scan for active devices in your network using ICMP and TCP port checks. YomiNet IP Scanner supports IP ranges, CIDR subnets, and hostnames."
keywords:
  [
    YomiNet,
    IP scanner,
...
no network connection), YomiNet iterates over active network adapters and selects the first valid IPv4 address,
...
**Type:** `List<YomiNet.Utilities.CustomCommandInfo>`
