---
sidebar_position: 0
description: "View the status of your network connection at a glance. The YomiNet Dashboard monitors adapter changes and checks router and internet connectivity."
keywords: [YomiNet, dashboard, network status, network connection, network monitoring, connectivity check]
---
