---
sidebar_position: 6
description: "Trace the route packets take to reach a destination host using ICMP. YomiNet Traceroute visualizes network hops and response times."
keywords: [YomiNet, traceroute, network hops, route tracing, network path, ICMP trace, network diagnostics]
---
