---
sidebar_position: 0
description: "Explore YomiNet, a free open-source Windows tool with 25+ built-in network tools including IP Scanner, Port Scanner, Remote Desktop, PowerShell, and PuTTY."
keywords: [YomiNet, network management, network tools, open source, Windows, IP scanner, port scanner, remote desktop, SSH, PuTTY, PowerShell, network troubleshooting]
---

# Introduction

YomiNet is a powerful open-source tool for managing networks and troubleshooting network problems!

![YomiNet Preview](https://github.com/BornToBeRoot/YomiNet/raw/main/Website/static/img/preview-features.gif?raw=true)

## Features

YomiNet comes with various built-in tools. See the documentation for detailed information about each feature:
...
YomiNet comes with dark and light themes and multiple accent colors. You can also provide custom theme files. See the [Appearance settings](./settings/appearance.md) for more information.

## Languages

Thanks to the community, YomiNet is available in more than 16 [languages](https://app.transifex.com/BornToBeRoot/YomiNet/dashboard/). If you want to help translate YomiNet, you can find everything to get started in the [contributing guidelines](https://github.com/BornToBeRoot/YomiNet/blob/main/CONTRIBUTING.md).
