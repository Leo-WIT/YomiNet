  ...
  headTags: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        url: "https://borntoberoot.net/YomiNet",
        downloadUrl:
          "https://borntoberoot.net/YomiNet/download",
        author: {
          "@type": "Person",
          name: "BornToBeRoot",
        ...
        license:
          "https://github.com/BornToBeRoot/YomiNet/blob/main/LICENSE",
      }),
    },
  ],
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            "https://github.com/bornToBeRoot/YomiNet/tree/main/Website/",
        },
        blog: {
    ...
    ({
      ...
      metadata: [
        {
          name: "keywords",
          content:
            "YomiNet, network manager, network tools, IP scanner, port scanner, ping monitor, traceroute, DNS lookup, remote desktop, SSH, PuTTY, PowerShell, VNC, WiFi analyzer, subnet calculator, SNMP, network troubleshooting, Windows network tool, open source",
        },
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/BornToBeRoot/YomiNet",
            label: "GitHub",
            position: "right",
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: "Transifex",
                href: "https://app.transifex.com/BornToBeRoot/YomiNet/",
              },
              {
                label: "Code of Conduct",
                href: "https://github.com/BornToBeRoot/YomiNet/blob/main/CODE_OF_CONDUCT.md",
              },
            ],
          },
        ],
