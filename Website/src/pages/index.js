      ...
      <div className={styles.heroInner}>
        ...
        <div className={styles.indexCtas}>
          ...
          <Link
            ...
            to="https://github.com/BornToBeRoot/YomiNet"
          >
            GitHub
          </Link>
          <span className={styles.indexCtasGitHubButtonWrapper}>
            <img
              ...
              src="https://img.shields.io/github/downloads/BornToBeRoot/YomiNet/total.svg?style=social"
              height={24}
            ...
            <img
              alt="GitHub Stars"
              className={styles.indexCtasGitHubButton}
              src="https://img.shields.io/github/stars/BornToBeRoot/YomiNet?style=social"
              height={24}
              title="GitHub Stars"
            />
          </span>
...
export default function Home() {
  return (
    <Layout
      ...
      description="YomiNet - A powerful open-source tool for managing networks and troubleshooting network problems. 25+ built-in network tools for daily use."
    >
      <HomepageHeader />
      <main>
        <ToolGrid />
