...
public class LocalizationInfo
{
    ...
    /// <param name="remark"><see cref="Remark" />.</param>
    public LocalizationInfo(string name, string nativeName, Uri flagUri, string code, bool isOfficial = false, string remark = null)
    {
        Name = name;
    ...
    /// <summary>
    ///     Additional display note for the language.
    /// </summary>
