...
namespace YomiNet.Models.PuTTY;
...
public static class PuTTY
{
    ...
    /// <summary>
    ///     Default SZ registry keys for PuTTY profile YomiNet.
    /// </summary>
    ...
    /// <summary>
    ///     Default DWORD registry keys for PuTTY profile YomiNet.
    /// </summary>
    ...
    /// <summary>
    ///     SZ registry keys for PuTTY profile YomiNet if app theme is dark.
    /// </summary>
    ...
    /// <summary>
    ///     SZ registry keys for PuTTY profile YomiNet if app theme is white.
    /// </summary>
    ...
    /// <summary>
    ///     Write the default PuTTY profile YomiNet to the registry.
    ///     HKCU\Software\SimonTatham\PuTTY\Sessions\YomiNet
    /// </summary>
    ...
    {
        var profilePath = @"Software\SimonTatham\PuTTY\Sessions\YomiNet";
