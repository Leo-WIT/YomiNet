...
namespace YomiNet.Documentation;

/// <summary>
///     This class is designed to interact with the documentation at https://borntoberoot.net/YomiNet/.
/// </summary>
public static class DocumentationManager
{
    ...
    /// </summary>
    private const string DocumentationBaseUrl = @"https://borntoberoot.net/YomiNet/";
