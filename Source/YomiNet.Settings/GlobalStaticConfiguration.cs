...
using YomiNet.Models.RemoteDesktop;
...
public static class GlobalStaticConfiguration
{
    ...
    // Settings: Window
    public static bool SplashScreen_Enabled => false;

    // Settings: Appearance
    public static string Appearance_Theme => "Light";
    ...
    public static bool Dashboard_CheckIPApiDNSResolver => true;
    ...
    public static string PuTTY_DefaultProfile => "YomiNet";
