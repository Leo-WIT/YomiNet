...
public class ConfigurationInfo : PropertyChangedBase
{
    ...
    /// <summary>
    ///     Execution path of the application like "C:\Program Files\YomiNet".
    /// </summary>
    public string ExecutionPath { get; }

    /// <summary>
    ///     Full path of the application like "C:\Program Files\YomiNet\YomiNet.exe"
    /// </summary>
    public string ApplicationFullName { get; }

    /// <summary>
    ///     Application name like "YomiNet".
    /// </summary>
