...
using YomiNet.Models.EventSystem;
using YomiNet.Models.Network;
using YomiNet.Profiles;
using YomiNet.Settings;
using YomiNet.Update;
...
public sealed partial class MainWindow : INotifyPropertyChanged
{
    ...
    public MainWindow()
    {
        ...
        // Set window title
        Title = $"YomiNet {AssemblyManager.Current.Version}";
    ...
    private async void WelcomeThenLoadAsync()
    {
        ...
        if (SettingsManager.Current.WelcomeDialog_Show)
        {
            ...
            var viewModel = new WelcomeViewModel(instance =>
            {
                ...
                SettingsManager.Current.Dashboard_CheckIPApiIPGeolocation = false;
                SettingsManager.Current.Dashboard_CheckIPApiDNSResolver = instance.CheckIPApiDNSResolver;
                SettingsManager.Current.Traceroute_CheckIPApiIPGeolocation = false;
    ...
    private void LoadApplicationList()
    {
        ...
        Applications.Filter = o =>
        {
            ...
            if (!ApplicationManager.IsEnabled(info.Name))
                return false;
    ...
    private void CheckForUpdates()
    {
        ...
        updater.CheckOnGitHub(Properties.Resources.YomiNet_GitHub_User,
            Properties.Resources.YomiNet_GitHub_Repo, AssemblyManager.Current.Version,
    ...
    private void Updater_UpdateAvailable(object sender, UpdateAvailableArgs e)
    {
        UpdateReleaseUrl = e.Release.Prerelease
            ? e.Release.HtmlUrl
            : Properties.Resources.YomiNet_LatestReleaseUrl;
    ...
    private void InitNotifyIcon()
    {
        ...
        using (var iconStream = Application
                   .GetResourceStream(new Uri("pack://application:,,,/YomiNet.ico"))?.Stream)
        {
            if (iconStream != null)
