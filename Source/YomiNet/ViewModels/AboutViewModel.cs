...
public class AboutViewModel : ViewModelBase
{
    ...
    private async Task CheckForUpdatesAsync()
    {
        ...
        updater.CheckOnGitHub(Resources.YomiNet_GitHub_User, Resources.YomiNet_GitHub_Repo,
    ...
    public string DevelopedByText =>
        string.Format(Strings.DevelopedAndMaintainedByX + " ", Resources.YomiNet_GitHub_User);
    ...
    private void Updater_UpdateAvailable(object sender, UpdateAvailableArgs e)
    {
        ...
        UpdateReleaseUrl = e.Release.Prerelease ? e.Release.HtmlUrl : Resources.YomiNet_LatestReleaseUrl;
