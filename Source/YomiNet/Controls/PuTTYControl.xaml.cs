...
using YomiNet.Models.PuTTY;
using YomiNet.Settings;
using YomiNet.Utilities;
using PuTTY = YomiNet.Models.PuTTY.PuTTY;
...
public partial class PuTTYControl : UserControlBase, IDragablzTabItem, IEmbeddedWindow
{
    ...
    private void UserControl_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        // Fix 2: Somehow the initial size need to be 20px smaller than the actual size after using Dragablz (https://github.com/BornToBeRoot/YomiNet/pull/2678)
        // Fix 3: The size needs to be scaled by the DPI, otherwise the embedded window is too small on high DPI screens (https://github.com/BornToBeRoot/YomiNet/pull/3352)
