...
public partial class TigerVNCControl : UserControlBase, IDragablzTabItem
{
    ...
    private void UserControl_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        // Fix 2: The size needs to be scaled by the DPI, otherwise the embedded window is too small on high DPI screens (https://github.com/BornToBeRoot/YomiNet/pull/3352)
                ...
                if (_appWin != IntPtr.Zero)
                {
                    ...
                    if (!_process.HasExited)
                    {
                        ...
                        style &= ~(NativeMethods.WS_CAPTION | NativeMethods.WS_POPUP |
                                   NativeMethods
                                       .WS_THICKFRAME); // NativeMethods.WS_POPUP --> Overflow? (https://github.com/BornToBeRoot/YomiNet/issues/167)
