...
public partial class App
{
 ...
 |_| \_|_____| |_|   \_/\_/ \___/|_|  |_|\_\_|  |_|\__,_|_| |_|\__,_|\__, |\___|_|   
                                               ...
                                               by BornToBeRoot
                                               GitHub.com/BornToBeRoot/YomiNet
...
";
        ...
        {
            Log.Info(
                $"Waiting for another YomiNet process with Pid {CommandLineManager.Current.RestartPid} to exit...");

            var processList = Process.GetProcesses();
            var process = processList.FirstOrDefault(x => x.Id == CommandLineManager.Current.RestartPid);
            process?.WaitForExit();

            Log.Info($"YomiNet process with Pid {CommandLineManager.Current.RestartPid} has been exited.");
        }
        ...
        if (!mutexIsAcquired && !SettingsManager.Current.Window_MultipleInstances)
        {
            ...
            Log.Info(
                "Another YomiNet process is already running. Trying to bring the window to the foreground...");
